...
config.JobType.scriptExe = 'crab_script_2017_data.sh'
config.JobType.inputFiles = ['../keep_and_drop.txt','../postproc_2017_data.py','../../../../../../scripts/haddnano.py'] #hadd nano will not be needed once nano tools are in cmssw
