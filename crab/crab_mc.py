...
config.General.workArea = '/afs/cern.ch/work/s/scoopers/private/crabspace/crab_projects/VHbbPostNano/2016/V2/'
...
config.JobType.scriptArgs = ['1','2016']
...
if __name__ == '__main__':
   ...
   #		config.Data.outLFNDirBase = '/store/user/%s/NanoTestProd006/' % (getUsernameFromSiteDB())
	...
	n+=1
	nnn="%s"%n
        config.General.requestName = "VHbbPostNano2016_V2_"+dataset.split('/')[1][:30]+dataset.split('/')[2][:30]+nnn
